 ...
 */
@Service
public class WF152SubmitServiceImpl extends TaskCommon implements InitializingBean {

    private static final Logger logger = LoggerFactory.getLogger(WF152SubmitServiceImpl.class);
    ...
    public void afterPropertiesSet() throws Exception {
        WfDealRoleRegisterFactory.register(RoleName.WF_ROLE_152.getCode(), this);
    }

    /**
     * 总行风险管理部复核岗（金融市场部） 执行任务
     *
     * @param taskNo           任务编号
     * @param code             流程启动编号
     * @param user             用户信息
    ...
    protected Map<String, Object> assembleParam(String taskNo, WfCode code, SysUser user, String processCondition) {
        ...
        map.put(RoleName.WF_ROLE_152.getInfo(), user.getUserId()); //总行风险管理部复核岗（金融市场部）操作人 id
