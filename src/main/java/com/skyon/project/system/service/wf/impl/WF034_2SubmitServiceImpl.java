 ...
 */
@Service
public class WF034_2SubmitServiceImpl extends TaskCommon implements InitializingBean {

    private static final Logger logger = LoggerFactory.getLogger(WF034_2SubmitServiceImpl.class);
    ...
    public void afterPropertiesSet() throws Exception {
        WfDealRoleRegisterFactory.register(RoleName.WF_ROLE_034.getCode() + "_2", this);
    }
    ...
    protected Map<String, Object> assembleParam(String taskNo, WfCode code, SysUser user, String processCondition) {
        ...
        if (code == WfCode.WF1101) {
            ...
            map.put(RoleName.WF_ROLE_044.getInfo(), RoleName.WF_ROLE_044.getCode()); // 二级分行检测审核岗（零售）审核
        }
